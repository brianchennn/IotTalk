...
mac_addr = 'C860068BD259'  # put here for easy to modify;;  the mac_addr in DAN.py is NOT used
...
DAN.profile['dm_name']='6D-Dummy_Device.OUT'   # you can change this but should also add the DM in server
